...
combined_data$NY.GDP.PCAP.KD.LOG <- log(combined_data$NY.GDP.PCAP.KD)

my_controls <- "NY.GDP.PCAP.KD.LOG + NE.TRD.GNFS.ZS + SE.SEC.ENRR"
```
...
coef_map_controls <- c(
  ...
  "NY.GDP.PCAP.KD.LOG" = "Log of GDP per capita"
)
